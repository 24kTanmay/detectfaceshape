    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-6xl mx-auto px-6 py-16 flex-grow">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl font-black font-mono tracking-tight text-white mb-6 leading-tight">
            Expert Biometrics <br />& <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Styling Ratios</span>
          </h1>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 pb-6 border-b border-slate-900">
              ...
              <button
                ...
                className={`px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-xl transition-all duration-200 whitespace-nowrap ${
                  selectedCategory === cat
                    ...
                    : "bg-slate-900 border border-slate-800 text-slate-400 hover:bg-slate-800/80 hover:text-white"
                }`}
              >
                {cat}
              </button>
          ...
          <div className="relative w-full md:max-w-xs">
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-200 placeholder-slate-500 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/25 transition-all duration-300"
            />
        ...
        {filteredPosts.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            {filteredPosts.map((post) => (
              <article 
                key={post.slug}
                className="group relative bg-slate-950 border border-slate-900 rounded-2xl overflow-hidden hover:border-slate-800 transition-all duration-300 flex flex-col justify-between h-full"
              >
                <div>
                  ...
                  <div className="aspect-video w-full relative overflow-hidden bg-slate-900 flex items-center justify-center">
                    ...
                    <span className="absolute top-4 left-4 z-10 px-2.5 py-1 rounded-lg bg-slate-950/80 border border-slate-800 text-[10px] font-bold font-mono text-blue-400 uppercase tracking-wider backdrop-blur-sm">
                      {post.category}
                    </span>
                  </div>
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold font-mono text-white tracking-tight mb-3 group-hover:text-blue-400 transition-colors duration-200">
          ...
          <div className="text-center py-20 bg-slate-900/10 border border-dashed border-slate-900 rounded-2xl">
            ...
            <h3 className="text-lg font-bold text-white font-mono mb-2">No Articles Found</h3>
