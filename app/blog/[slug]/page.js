...
export default function BlogPostPage({ params }) {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between relative overflow-hidden">
      ...
      <header className="z-50 w-full max-w-6xl mx-auto px-6 py-4 mt-6 bg-slate-950/70 border border-slate-900/80 rounded-2xl backdrop-blur-md flex justify-between items-center shadow-none relative">
        <Link href="/" className="flex items-center gap-3.5 group select-none">
          ...
          <span className="font-black tracking-tight text-base sm:text-lg text-white transition-colors duration-300 group-hover:text-blue-500">
            Detect Face Shape
          </span>
        </Link>

        <nav className="hidden md:flex items-center gap-8">
          <Link href="/" className="text-xs font-bold uppercase tracking-wider text-slate-400 hover:text-blue-400 transition-colors duration-150">
            Face Shape Detector
          </Link>
          <Link href="/blog" className="text-xs font-bold uppercase tracking-wider text-blue-400 transition-colors duration-150">
            Blog
          </Link>
          <Link href="/contact" className="text-xs font-bold uppercase tracking-wider text-slate-400 hover:text-blue-400 transition-colors duration-150">
            Contact Us
          </Link>
        </nav>

        <div className="flex items-center gap-3">
          <Link href="/" className="px-4 py-2 text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/35 transition-all duration-300 hover:scale-105 active:scale-95">
            Start Analysis
          </Link>
        </div>
      </header>
      ...
      <div className="z-10 w-full max-w-5xl mx-auto px-6 py-12 flex-grow">
        ...
        <Link 
          href="/blog"
          className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400 hover:text-blue-400 mb-8 transition-colors duration-200"
        >
        ...
        {/* Article Meta Header */}
        <div className="mb-10">
          <span className="px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs font-bold font-mono text-blue-400 uppercase tracking-wider">
            {post.category}
          </span>
          <h1 className="text-3xl sm:text-5xl font-black font-mono text-white tracking-tight mt-4 mb-6 leading-tight max-w-4xl">
            {post.title}
          </h1>
        ...
        <div className="w-full aspect-video rounded-3xl overflow-hidden bg-slate-900 border border-slate-900 mb-12 shadow-2xl relative">
          {post.coverImage ? (
            <img 
              src={post.coverImage} 
              alt={post.title} 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8">
            <article 
              className="prose prose-invert max-w-none prose-h3:font-mono prose-h3:text-white prose-p:text-slate-300 prose-p:leading-relaxed"
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-6 space-y-6">
              ...
              <div className="relative overflow-hidden bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-6 shadow-2xl text-center">
                ...
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 mx-auto mb-4 shadow-lg shadow-blue-500/5">
                ...
                <h3 className="text-xl font-bold font-mono text-white mb-2">Find Your Match</h3>
              ...
              {/* Share Box */}
              <div className="bg-slate-950 border border-slate-900 rounded-3xl p-6 text-center">
                <h4 className="text-xs font-bold font-mono text-slate-400 uppercase tracking-widest mb-3">Share This Guide</h4>
                <div className="flex justify-center gap-3">
                  ...
                  <a 
                    ...
                    className="w-10 h-10 rounded-xl bg-slate-900 hover:bg-white hover:text-slate-950 text-slate-400 flex items-center justify-center transition-colors duration-250"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-10 h-10 rounded-xl bg-slate-900 hover:bg-emerald-600 hover:text-white text-slate-400 flex items-center justify-center transition-colors duration-250"
                  >
        ...
        <div className="mt-20 pt-10 border-t border-slate-900">
          <h3 className="text-2xl font-bold font-mono text-white mb-8 text-center">Recommended For You</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {relatedPosts.map((rPost) => (
              <div 
                key={rPost.slug}
                className="group relative bg-slate-950 border border-slate-900 rounded-2xl overflow-hidden hover:border-slate-800 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="aspect-video w-full relative overflow-hidden bg-slate-900">
                    ...
                    <div className="hidden absolute inset-0 bg-slate-950 flex-col items-center justify-center p-6 text-center">
                  ...
                  <div className="p-6">
                    <span className="text-[10px] font-bold font-mono text-blue-400 uppercase tracking-widest">{rPost.category}</span>
                    <h4 className="text-lg font-bold font-mono text-white tracking-tight mt-2 mb-2 group-hover:text-blue-400 transition-colors duration-200">
                ...
                <div className="px-6 pb-6 pt-0">
                  <Link 
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-blue-400 hover:text-cyan-400"
                  >
                    Read Guide
      ...
      {/* Centered Footer */}
      <footer className="z-10 w-full border-t border-slate-900 bg-slate-950 py-16 px-6 relative mt-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pb-12 border-b border-slate-900 text-center justify-items-center">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="font-bold font-mono tracking-wider text-base uppercase text-white">
          ...
          {/* Tools Col */}
          <div className="flex flex-col items-center text-center space-y-4">
            <h4 className="font-bold text-sm uppercase tracking-wider text-white font-mono">
              Online Suite
            </h4>
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/" className="text-slate-400 hover:text-blue-400 transition-colors">Face Shape Detector</Link></li>
              <li><Link href="/" className="text-slate-400 hover:text-blue-400 transition-colors">Symmetry Diagnostics</Link></li>
              <li><Link href="/" className="text-slate-400 hover:text-blue-400 transition-colors">Hairstyle Recommendations</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/contact" className="text-slate-400 hover:text-blue-400 transition-colors">Support Center</Link></li>
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex gap-3.5">
              <a href="https://www.instagram.com/rtanmay588/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-900 hover:bg-gradient-to-tr hover:from-yellow-500 hover:via-pink-500 hover:to-indigo-500 hover:text-white text-slate-400 flex items-center justify-center transition-all duration-300 hover:scale-105">
              ...
              <a href="https://x.com/TanmayR98734842" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-slate-900 hover:bg-white hover:text-slate-950 text-slate-400 flex items-center justify-center transition-all duration-300 hover:scale-105">
