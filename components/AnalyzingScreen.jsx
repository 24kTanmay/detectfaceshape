...
export default function AnalyzingScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 p-6 overflow-hidden relative">
      ...
      <div className="z-10 flex flex-col items-center max-w-md w-full text-center">
        ...
        <div className="relative w-40 h-40 mb-12 flex items-center justify-center">
          ...
          {/* Inner solid border */}
          <div className="absolute inset-6 border border-blue-500/60 rounded-full flex items-center justify-center bg-white/80 dark:bg-slate-900/80 shadow-2xl shadow-blue-500/10">
        ...
        <div className="space-y-4 w-full px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-slate-900 border border-blue-500/30 text-xs font-semibold tracking-wider text-blue-400 uppercase shadow-sm">
          ...
          <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white min-h-[3rem] flex items-center justify-center px-4 transition-all duration-300">
            {messages[currentMessage]}
          </h2>

          {/* Precision percentage progress bar */}
          <div className="w-full bg-white/80 dark:bg-slate-900/80 rounded-full h-2.5 p-0.5 border border-slate-300 dark:border-slate-800 shadow-inner mt-6 overflow-hidden">
            <div
        ...
        <div className="mt-12 flex items-center justify-center gap-2 text-slate-600 dark:text-slate-400 bg-white/50 dark:bg-slate-900/50 border border-slate-300/80 dark:border-slate-800/80 px-4 py-2.5 rounded-xl text-sm shadow-sm backdrop-blur-sm">
          <svg
