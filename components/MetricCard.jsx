...
export default function MetricCard({ label, value, description, icon }) {
  return (
    <div className="group relative bg-slate-900/60 border border-slate-800/80 hover:border-blue-500/40 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5 hover:-translate-y-0.5 overflow-hidden">
      ...
      <div className="flex items-baseline gap-2 mb-2">
        <span className="text-3xl font-black text-white tracking-tight group-hover:text-blue-200 transition-colors duration-300 font-mono">
          {value}
        </span>
      </div>
